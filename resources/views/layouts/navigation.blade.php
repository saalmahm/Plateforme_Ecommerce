<nav x-data="{ open: false }" class="bg-orange-500 border-b border-orange-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-300 hover:bg-orange-600 focus:outline-none focus:bg-orange-600 focus:text-gray-300 transition duration-150 ease-in-out">
